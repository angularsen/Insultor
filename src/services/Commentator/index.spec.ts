...
// 		const startStates: State[] = ['detectFaces', 'detectPresence', 'identifyFaces', 'commentOnNextPerson']
...
// 				['idle', 'detectPresence', 'detectFaces', 'identifyFaces', 'commentOnNextPerson', 'detectFaces', 'detectPresence', 'idle'])
// 		} catch (err) {
...
// 			expect(comm.history).toEqual(
// 				['idle', 'detectPresence',
// 				'detectFaces', 'identifyFaces', 'commentOnNextPerson',
// 				'detectFaces', 'identifyFaces', 'commentOnNextPerson',
// 				'detectFaces'])
// 		} catch (err) {
// 			console.error('Error received', err.stack || err)
